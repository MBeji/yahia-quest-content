# 📜 Résumé : Les états physiques de la matière
...
- **Description microscopique.** Les **particules** sont au contact et **ordonnées** dans le solide (peu agitées), au contact mais **désordonnées** dans le liquide (elles glissent), **dispersées et très agitées** dans le gaz.
