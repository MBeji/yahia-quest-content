# 📜 Résumé : L'intensité du courant électrique
...
- **Fusible et sécurité.** Un **fusible** fond dès que l'intensité dépasse un seuil et coupe le courant. Pour le corps humain : 30 mA → paralysie, 50 mA → asphyxie, 100 mA → fibrillation cardiaque.
