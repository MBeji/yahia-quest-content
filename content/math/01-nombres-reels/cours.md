...
- **كتابة عشرية متناهية** (تتوقّف): 3/8 = 0,375 و 9/4 = 2,25.
- **كتابة عشرية دوريّة غير متناهية**: مجموعة من الأرقام تتكرّر بلا توقّف.
...
::: definition
العدد الذي كتابته العشرية **غير متناهية وغير دوريّة** معًا يسمّى **عددًا أصمّ**، ولا يمكن كتابة
...
::: definition
الجذر التربيعي لعدد حقيقي موجب a هو العدد الحقيقي **الموجب** b الذي مربّعه يساوي a:
$$ √a = b ⟺ a = b² $$
:::
...
3. العدد 1,4 هو **قيمة تقريبية بالنقصان** (الحدّ الأصغر)، والعدد 1,5 **بالزيادة** (الحدّ الأكبر).
...
هي **وحدة التدريج**. يصير المستقيم (OI) عندئذ **المستقيم العددي**، وإذا كانت x فاصلة النقطة M
نكتب M(x).
:::
