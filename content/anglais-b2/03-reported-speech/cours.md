# 🗣️ Reported Speech — The Art of the Second-Hand Story
...
> 🏆 Gate cleared! You can now relay intel from any source. Next on the quest: **Advanced Conditionals** — where you'll explore past regrets, present wishes, and the art of the hypothetical.
