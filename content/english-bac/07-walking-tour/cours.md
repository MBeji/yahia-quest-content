# ⚔️ Walking Tour — Reading the Ad, Showing the Way

> 💡 "An ad never lies to you. It simply tells you the half that makes you come — and reading it well means hearing the other half."

A city sells itself twice: once on a **map**, where it is only a name in the right place, and once in an **ad**, where it is the best thing that will ever happen to you. This lesson puts the two side by side. You will learn to read the map of the British Isles without falling into the trap that catches half the candidates at the bac — **Great Britain and the United Kingdom are not the same thing** — then to read a walking-tour ad the way a careful traveller reads it, and finally to take the microphone yourself and **plan a guided tour of your own town**. On the way you will pick up the grammar that every brochure in the world is built on, the **superlative**, and the difference between the **long and short vowels** that decides whether your group hears _walk_ or _work_.

## 🗺️ The map first — four names that are not four ways of saying the same thing

Look at the map at the top of the lesson and read it slowly. Four names sit on top of one another like boxes inside boxes.

| Name                     | What it names               | What is inside it                                                          |
| ------------------------ | --------------------------- | -------------------------------------------------------------------------- |
| **the British Isles**    | a **group of islands**      | Great Britain, Ireland and thousands of smaller islands                     |
| **Great Britain**        | one **island** — the larger | England, Scotland and Wales                                                 |
| **Ireland**              | the other main **island**   | the Republic of Ireland, and Northern Ireland in its north-east corner      |
| **the United Kingdom**   | a **state**, a country      | England, Scotland, Wales **and Northern Ireland**                           |

Read the table again with one question in mind: *is this word naming a piece of land, or a country?* **Great Britain is a piece of land.** **The United Kingdom is a country.** That is the whole difference, and everything else follows from it.

Three consequences you must be able to say out loud:

- **Northern Ireland is in the United Kingdom, but not on the island of Great Britain.** It sits on the island of Ireland, and you cannot walk to it from London.
- **The Republic of Ireland is in the British Isles, but not in the United Kingdom.** It is an independent country with its own government, and Dublin is its capital.
- The full official name of the state says both halves out loud: **the United Kingdom of Great Britain and Northern Ireland**.

The four countries that make up the United Kingdom are called its **constituent countries** — *constituent* simply means *forming a part of*. Each keeps its own capital:

| Constituent country  | Capital       | Which island?           |
| -------------------- | ------------- | ----------------------- |
| **England**          | London        | Great Britain           |
| **Scotland**         | Edinburgh     | Great Britain           |
| **Wales**            | Cardiff       | Great Britain           |
| **Northern Ireland** | Belfast       | Ireland                 |

And beside them, on the same map but outside the United Kingdom: the **Republic of Ireland**, capital **Dublin**.

The water around the islands has names too, and an examiner may ask for them: the **Atlantic Ocean** to the **west**, the **North Sea** to the **east**, and the **English Channel** to the **south**, between Great Britain and France.

> ⚠️ **The three sentences that lose marks.** "Northern Ireland is part of Great Britain" ✗ — it is part of the United Kingdom. "Great Britain and the United Kingdom are two names for the same thing" ✗ — one is an island, the other a state. "Dublin is a British city" ✗ — Dublin is the capital of an independent republic.

## 🏴 Describing a country — the model sentence

Your book gives one sentence about Scotland and asks you to write the same sentence about another country. It is worth taking apart, because it is a model you can use for any place on earth:

> _Scotland is one of the **constituent countries** of the United Kingdom. It **occupies** the northern third of the island of Great Britain and **shares a land border** to the south with England._

Three moves, always in the same order:

1. **Name the whole it belongs to** — _one of the constituent countries of the United Kingdom_.
...
| Word                     | What it means                                                        |
| ------------------------ | -------------------------------------------------------------------- |
| **border**               | the line where one country ends and the next begins — a frontier      |
| **constituent**          | forming a part of a larger whole                                      |
| **cosmopolitan**         | full of people from many different countries and cultures             |
| **venue**                | a place where a show, a match or a concert is held                    |
| **year round**           | in all four seasons, all through the year                             |
| **residence**            | the house someone lives in, usually a grand one                       |
| **official**             | belonging to a post or a duty, not to the person                      |
...
- **The highlight is announced.** One thing is picked out and put in capitals — here, the Changing of the Guard. That is the reason the reader is meant to come.
...
| ----------------- | ----------------------------------------------------------------------------------- |
| describing        | _It stands / lies / occupies… · It dates from… · It is known for… · It is home to…_ |
...
## ⭐ The superlative — the grammar every brochure runs on

Two shapes, and one thing decides between them: **the length of the adjective**.

| The adjective                       | The shape             | Examples                                                          |
| ----------------------------------- | --------------------- | ------------------------------------------------------------------ |
| **short** (one syllable, and two-syllable adjectives in _-y_) | **the** + adjective + **-est** | the **oldest** house · the **warmest** room · the **youngest** child · the **largest** city · the **busiest** street |
| **long** (two syllables or more)     | **the most** + adjective | the **most captivating** museum · the **most memorable** evening · the **most spectacular** ceremony · the **most cosmopolitan** city |

Four spelling rules for the _-est_ form:

| Ending of the adjective        | What happens          | Example                  |
| ------------------------------ | --------------------- | ------------------------ |
| already ends in **-e**         | add **-st** only      | large → the **largest**  |
| ends in consonant + **-y**     | **y** becomes **i**   | busy → the **busiest**   |
| one vowel + one consonant      | **double** the consonant | hot → the **hottest**  |
| anything else                  | add **-est**          | old → the **oldest**     |

And four adjectives refuse both shapes and must be learnt:

**good → the best** · **bad → the worst** · **far → the furthest** · **little → the least**
...
**3. Its true strength.** And here is where a brochure gets clever, because English has two ways of weakening a superlative without looking as if it is weakening anything:

| What is written                                | What is really claimed                             |
| ---------------------------------------------- | -------------------------------------------------- |
| _the largest city in Scotland_                 | nothing in Scotland is larger — the top, full stop  |
...
English vowels come in two lengths, and the length is part of the word. The two dots **ː** in the phonetic symbol mean *hold it*.

| Symbol   | Length | Key word    | The spellings that usually give it      | More examples                     |
| -------- | ------ | ----------- | ---------------------------------------- | --------------------------------- |
| **/ɔː/** | long   | w**a**lk    | _al_, _aw_, _au_, _or_, _oor_, _war_     | talk · north · more · warm · door |
| **/ɜː/** | long   | f**ir**st   | _ir_, _er_, _ur_, _ear_, _wor_           | church · world · turn · learn · girl |
| **/ɑː/** | long   | g**uar**d   | _ar_, _al_ in _half_, _ass_, _ast_       | heart · park · star · half · fast |
| **/ɒ/**  | short  | **o**dd     | a single _o_ in a closed syllable, _wa_  | novel · stop · watch · want · college |

> ⚠️ Your textbook prints these four as `/ɔ:/`, `/ə:/`, `/a:/` and `/ɔ/`. The symbols above are the ones you will meet in a dictionary; they name exactly the same four sounds.

The point of the exercise is not to recite symbols — it is that **length changes the word**:

| Long                       | Short                    |
| -------------------------- | ------------------------ |
| c**ar**t /kɑːt/            | c**a**t /kæt/            |
| p**or**t /pɔːt/            | p**o**t /pɒt/            |
| sh**ee**p /ʃiːp/           | sh**i**p /ʃɪp/           |

> 🗡️ **The one that catches every guide in the world: _walk_ and _work_.** _Walk_ is /wɔːk/, the vowel of _north_ and _more_. _Work_ is /wɜːk/, the vowel of _first_ and _church_. Say the wrong one and your group hears that you are taking them to the office.

### The other pronunciation box: _th_

Two words of the map hide a change of sound inside them:

| Word         | The _th_                        | Like the _th_ of… |
| ------------ | ------------------------------- | ----------------- |
...
- _Northern Ireland is part of Great Britain._ ✗ → it is part of the **United Kingdom**; Great Britain is the other island.
...
> 🏆 Gate cleared, hero. You can put four names on a map without mixing an island up with a state, read an ad for what it prints **and** for what it hides, weigh a superlative for its real strength, and take a group of strangers round your own town for two hours without losing one of them. Next quest: **A Package Tour** — where somebody else writes the ad, and you have to answer it.
