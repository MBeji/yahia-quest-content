# ⚔️ A Package Tour — Reading the Offer, Writing Back
...
Travel vocabulary falls into four families, and knowing which family a word belongs to tells you what kind of question it answers.

| Family                  | The question it answers                        | The words                                        |
| ----------------------- | ---------------------------------------------- | ------------------------------------------------ |
| **Accommodation**       | Where do I sleep, and what does the room cover? | full board · single room · camp site · to check in |
| **Means of transport**  | How do I get there and back?                    | coach · jet · passenger · return ticket           |
| **Tourism**             | Who sells me the journey, and what is it?       | package tour · journey · travel agent             |
| **Sightseeing**         | What do I go and look at once I am there?       | monument · temple · palace · statue               |

And what each one means when it is printed on a form or in a brochure:
...
| **coach**           | a large, comfortable bus built for long journeys                                       |
| **jet**             | a fast aircraft driven by jet engines                                                  |
| **passenger**       | anybody travelling in a vehicle who is not driving it                                  |
| **return ticket**   | a ticket that takes you there **and** brings you back (a **single** only takes you there) |
| **package tour**    | travel, accommodation and often meals, sold together at **one** price                  |
| **travel agent**    | the person — and the shop — that sells you the journey                                 |
| **journey**         | the act of going from one place to another                                             |
| **monument**        | a building or a structure raised to keep a person or an event in memory                |
...
A timetable informs. A dictionary informs. An **ad** wants something from you, and everything on the page is built to get it. Four moves do the work:
...
## 🔍 Evaluating an ad — the four questions to ask it
...
| ----------------- | ---------------------------------------------------------------------- |
| **admission**     | the right to enter a place — _free admission_ = you go in without paying |
| **discount**      | a **reduced** price: you pay less, you do not pay nothing               |
...
The lesson asks you a question your teacher will ask again: _would you take this package tour?_ Before you answer, know what you are weighing.

| The advantages of a package tour                         | The drawbacks                                                  |
| --------------------------------------------------------- | ---------------------------------------------------------------- |
| one price, paid once, with no surprises                    | the programme is **fixed**: the agency decides your third day     |
| everything is arranged — rooms, seats, entries             | you see what the agency chose, and not what you would have chosen |
| a guide who speaks the language and knows the way          | you move with a group, at the speed of the slowest               |
| it is nearly always cheaper than the same journey alone    | you meet the country through a window, and other tourists through the coach |

Then say it, and say **why**:

| Function                     | What you write or say                                                  |
| ---------------------------- | ------------------------------------------------------------------------ |
| giving an opinion            | _In my opinion… · I find it… · It seems to me that…_                     |
| judging the offer itself     | _It's worth it because… · It's not for us: it doesn't include…_          |
...
English has five short frames for saying that something attracts you. What matters is **where the thing goes**, because one of the five puts it in front and the other four put it behind.

| The frame                            | Where the thing goes                     | Example                                              |
| ------------------------------------ | ------------------------------------------ | ----------------------------------------------------- |
...
The screen gives you two boxes before you write a word.
...
Two vowels, and one rule decides between them.

- **[æ]** is the short, wide-open vowel of _cat_, _bad_, _man_. Your mouth opens and the sound is full. It turns up **only in a syllable that carries the stress**.
- **[ə]** — its name is **schwa** — is the weak, colourless vowel at the end of _teacher_ and at the start of _about_. It is the **commonest sound in English**, and it lives **only in syllables that carry no stress**.

So the two never compete: **find the stress first, and the vowel follows.**

The words of the lesson, with the vowel in question:

| Word                      | The vowel in question       | Sound                                              |
| ------------------------- | ----------------------------- | --------------------------------------------------- |
| **pack**age               | the a of _pack-_              | **[æ]** — stressed                                  |
| **acc**ess                | the first a                   | **[æ]** — stressed                                  |
| **cap**ital               | the first a                   | **[æ]** — stressed                                  |
| chance                    | the a                         | **[æ]** in American English, **[ɑː]** in British English |
| festi**val**              | the a of _-val_               | **[ə]** — unstressed                                |
| **a**nnounced             | the a of the first syllable   | **[ə]** — unstressed                                |
| sepa**rate** (adjective)  | the a of _-rate_              | **[ə]** — unstressed                                |

**One word can hold both.** _Capital_ is said **CAP**-i-tal, [ˈkæpɪtəl]: the first a is stressed and keeps its full [æ]; the last a is unstressed and collapses into [ə]. Same letter, same word, two different sounds — and no English speaker hears anything strange in that.

**One word changes with its job.** _Separate_ has two lives:
...
Three steps, and the whole lesson comes back in them.
