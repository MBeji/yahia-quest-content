...
Deux mots reviennent sans cesse pour désigner les deux bouts du corps : le **fond (48)** ferme l'arrière du vérin ; l'avant est fermé par le **nez**, l'embout que la tige traverse et qui porte son guidage et ses joints.
...
> 🗡️ La nomenclature annonce **deux** pistons (51) et **deux** joints de piston (64), plus une **tige intermédiaire** (49), un **palier intermédiaire** (50) et un **joint de tige arrière** (63) : ce vérin est un **vérin tandem**, deux étages montés en série sur le même axe pour doubler l'effort sans grossir le diamètre. La coupe donnée plus haut n'en représente qu'un étage — c'est lui qui porte tout le raisonnement, et le second se lit exactement pareil.
...
::: figure La condition Ja se referme ici sur quatre pièces : on part d'une face du bras, on traverse une bague, le tourillon, l'autre bague, et on arrive sur l'autre face du bras — le jeu et les collerettes sont volontairement exagérés, sinon on ne les verrait pas. Modèle simplifié pour l'entraînement : ses cotes sont notées b… et ne sont pas celles du manuel, qui compte séparément les deux paliers rapportés (21) et (70) et fait passer la chaîne par eux
...
On exige 0 ≤ Ja ≤ 0,2 avec b6 = 57,50 ± 0,04 · b2 = 54 ± 0,02 · b69 = b69' = 1,65 ± 0,02.
...
**La correction.** L'intervalle est de la bonne **largeur**, il est seulement mal **placé** : il suffit de **déplacer le nominal** de 0,10 mm, soit b6 = 57,40 ± 0,04. On obtient alors Ja maxi = 57,44 − 53,98 − 1,63 − 1,63 = **0,20** et Ja mini = 57,36 − 54,02 − 1,67 − 1,67 = **0,00** ✓ — l'intervalle tombe exactement dans la condition.
:::
