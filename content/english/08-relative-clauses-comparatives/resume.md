...
- **The superlative** — the top of a group of three or more: **the** + short adjective + **-est** (_the strongest boy in the school_), **the most** + long adjective (_the most beautiful_); **the** is never missing.
- **Equality with an adjective** — **as** + plain adjective + **as** (_Ahmed is as old as Omar_, _as generous as_); no -er and no more inside.
- **Equality of an amount** — **as much / as many** + noun + **as** (_as much pocket money as her brother_, _as many friends as my brother_); it closes with **as**, never _than_.
- **Going further (beyond the 9th-grade book, not tested)** — **whose** (possession), **where** (place), and the irregulars **good → better → the best**, **bad → worse → the worst**.
