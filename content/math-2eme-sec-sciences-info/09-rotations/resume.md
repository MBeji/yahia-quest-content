...
- **Éléments de symétrie usuels** : un **cercle** de centre O a O pour centre de symétrie et **toutes** les droites passant par O pour axes ; un **carré** de centre O a O pour centre et **quatre** axes, et il est invariant par la rotation d'angle **π/2** — seule valeur de ]0 ; π[ — et, au bord de l'intervalle, par le **demi-tour**, qui est sa symétrie centrale de centre O ; un **triangle équilatéral** a **trois** axes, **aucun** centre, et il est invariant par la rotation d'angle **2π/3**.
