...
|------|------|--------------------------|
| 2026-08-13 | **La position est tranchée, et le chantier est requalifié en goulot** (étude 28, lot 1 — PR #155). **D5** : position de référence = *la pratique et la maîtrise mesurée*, avec renoncement acté à concurrencer TakiAcademy sur le cours vidéo. **D6** : soutenabilité = **B2B établissement**, l'élève reste gratuit (ne préempte pas le dégel de é01). Constat qui motive tout : ce chantier est **livré à 100 % et exécuté à 0 %** depuis le 2026-06-13 — D1/D2/D3 tous ouverts, donc **aucun canal d'acquisition actif** alors que l'infra, le domaine, le SEO et les analytics sont verts. Le bloc D des 91-actions devient **chemin critique rentrée**, et « au moins un canal actif et mesuré » devient une **condition de la Porte 1** (master plan §3bis/§6). ⛔ D2 porte désormais sa précondition dure (é28 D-5) : rien vers un établissement avant GAP-024 livré et GAP-003 tranché. Au passage, ① domaine et ③ PostHog étaient encore listés « à faire » alors qu'ils sont soldés depuis le 2026-07-27. | **Exécution Mohamed, à J-19** : D1 (page Facebook, ~1 h, rien ne le bloque) → D3 (20-30 beta-testeurs, pour la première mesure de rétention) → D2 (école pilote, **après** GAP-024/GAP-003). |
