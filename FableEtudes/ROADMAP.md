...
- [ ] **P4. é20 — réponses acceptées : lots 4, 8 et 6.**
      **Lot 4** — campagne Tier B, une matière par PR, à décider sur la base du pilote (#96,
      ...
      `short_answer` : le sixième type natif existe depuis arena#654 et **n'est joué nulle part**,
      il attend en plus la doctrine R-14. **Lot 6** (optionnel) — boucle du refus contesté.
