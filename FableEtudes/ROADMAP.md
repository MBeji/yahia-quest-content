...
- [ ] **P3. é34 — étoiles de chapitre & sceaux de matière.** ✅ **Lots 1 et 2 LIVRÉS le
      ...
      livre au lieu de recalculer). Étude **validée le 2026-09-14**
      ...
      catalogue i18n paresseux `progress/`, `chapter-completion.ts` supprimé) ; restent **lot 3**
