...
- [ ] **C10. C8 — é21 lot 6 : passe savoirs (R-8) + axe « complétude manuel » dans
      `content-audit`.** _(A4 rendu : verbatim court non créatif toléré, provenance **non**
      ...
      **Ce qui reste au lot 6** : la passe savoirs (R-8) sur la matière pilote — première dette
      identifiée, le chapitre 9 interroge ce qui accélère l'évaporation sans que le cours ne
      l'enseigne — et l'axe « complétude manuel » de `content-audit`. Les 47 % non repris
      attendent, eux, que la fiche programme gagne en profondeur sur les pages concernées.
