...
- [ ] **P3. é34 — étoiles de chapitre & sceaux de matière.** ✅ **Lots 1, 2 et 3 LIVRÉS le
      ...
      KPI-E dans STATUS §1bis) ; restent **lot 4** célébrations et badges, **lot 5** (optionnel,
      ...
      à inventorier.
      ⚠️ Ce que le lot 3 laisse à surveiller : le chunk `dashboard` est à **35,07 / 36 KB** —
      le prochain lot qui touche au QG **découpe avant d'ajouter**.
