...
| **Brouillon — validation attendue**   | Q-1…Q-5 de é34 à arbitrer (vocabulaire · « maîtrisé » = étoile ≥ 3 · aucune récompense · échelle nommée GAP-037 · missions de la famille) | é34 (étoiles de chapitre & sceaux de matière — la progression cesse de reculer quand du contenu arrive ; écrite le 2026-09-14). **Approfondissement de V1**, pas une ouverture : dès validation, son lot 1 (SQL seul : `created_at`, grand livre, trigger, rejeu) entre en file PRODUIT derrière P4 ; les lots 2-4 suivent en chaîne, le lot 5 (GAP-037) est optionnel |
