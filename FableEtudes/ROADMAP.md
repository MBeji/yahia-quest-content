...
- [ ] F10. **LE GARDE PÉDAGOGIQUE EST EN PANNE DEPUIS LE 2026-07-29 — ligne ouverte le
      ...
      **Pourquoi ça mérite une ligne et pas une note de bas de page** : `content-audit.yml` est
      ...
      ⚠️ **La leçon est déjà écrite ailleurs, et elle s'est rejouée** : F8 bis (2026-07-25)
      constatait que « le garde pédagogique n'avait jamais tourné » — token OAuth invalide, déjà.
      Le mécanisme est le même à trois semaines d'écart : **une garde qui échoue en silence est
      ...
      ce qui manque n'est pas la garde, c'est le fait que **sa panne n'atteint personne**.
...
- [ ] C9. **Transcriptions secondaire (fil continu, METHODE-GENERATION-CONTENU).**
      ...
      **Généré dans la foulée** (même fenêtre, matières ci-dessus) : `english-3eme-sec` ch.01-06
      (#136, #139, #144) et `english-bac` ch.01-03 (#137) — **un dossier authored une fois, six
      terminales servies** — puis `french-bac` ch.01-03 (#141). Les correctifs d'audit qui ont
      suivi comptent autant que les tranches : #138, #140, #146, #147, #148 — **le manuel
      officiel s'est contredit plusieurs fois**, et c'est un audit en session qui l'a vu, pas un
      gate (voir **F10**).
