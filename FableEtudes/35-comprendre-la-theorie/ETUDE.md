...
> **Statut** : brouillon — écrite le 2026-09-16 ; **Q-1…Q-6 à arbitrer** (§7). Aucun lot n'est
> exécutable avant la validation de la fiche et l'arbitrage de Q-1 (le seul lot moteur).
...
- [ ] **Lot 1 — Le bloc `verifie` et les contrôles du patron.**
...
- [ ] **Lot 2 — La doctrine et le gabarit vivant.**
...
- **Q-1 — Le lot moteur (bloc `verifie`) : oui ou non ?** _Recommandation : **oui**._ C'est le
...
- **Q-2 — Le chapitre maquette.** _Recommandation : `06-fonctions-lineaires-affines`_ — zéro bloc
...
- **Q-3 — L'ordre des tranches.** _Recommandation : l'ordre du manuel_ (numérique → algèbre →
...
- **Q-4 — Un glossaire arabe → français en fin de cours ?** La 1ʳᵉ secondaire bascule les maths
...
- **Q-5 — La matière suivante, après le bilan.** _Recommandation : les deux autres matières
  ...
  bilan.
- **Q-6 — Le lot 7 (mesure) maintenant, ou au premier trafic ?** _Recommandation : **au premier
