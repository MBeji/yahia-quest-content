...
>
> **Transcrit le** : 2026-07-30. **Statut** : transcription fidèle **partielle** — **le seul المحور الأوّل
> (الشّعر الجاهلي, tome 1, p.5–83) est transcrit à profondeur de génération** (chaque texte, chaque rubrique
> du جهاز البيداغوجي, encadrés et ورقات منهجيّة verbatim, bornes ✅/⛔) ; les **8 autres chapitres sont
> codifiés au chapitrage (§4) avec leurs bornes de pages CONSTATÉES**, mais **non encore transcrits** — fiche
> **reprenable** (cf. registre `suivi/2eme-sec-lettres.json`, LA source de vérité de la couverture).
> ⚠️ **Génération (LOT B) RESTREINTE** : R-5 se lisant **au chapitre** depuis la décision du 2026-07-29, le
> **seul chapitre `01-shir-jahili` est générable** ; les 8 autres restent interdits tant que leur section
> n'est pas transcrite. La liste fait foi dans `chapitresGeneration` du registre, et `programme:check` la
> vérifie contre le chapitrage du manifeste.
>
...
`غرض الهجاء` (p.150 — محور 2). Le tome 1 en compte 10, le tome 2 également 10 (فهرس الورقات المنهجيّة,
...
## C1 Chapitre 1 — المحور الأوّل : الشّعر الجاهلي (tome 1, p.5–83, transcrit à profondeur de génération)
...
- **Montage du محور (fidèle au manuel)** :
  ...
  - **II – النصوص المختارة** (p.19–75) — page de titre de rubrique **p.19** (calligraphie magenta « نصوص مختارة ») ; **p.20** planche iconographique pleine page, légende verbatim : « "واحــــــــة" » / « لوحة للفنّان الحبيب بلال ». **p.21** : notice d'auteur pleine page « طرفة بن العبد », encadré bleu à 3 puces, verbatim intégral :
  ...
  - **ورقات منهجيّة** (p.34, 44, 52, 59, 65) — cinq fiches sur parchemin déroulé, étiquette en coin « ورقة منهجيّة », titre « كيف أقـرأ », sous-titre magenta variable. Transcription verbatim intégrale.
...
Chapitrage complet du manuel pour la **section Lettres** (9 chapitres, deux tomes).
Colonne **transcription** : ✅ = transcrit à profondeur de génération dans la présente fiche ; ⏳ = chapitre
codifié (bornes constatées) mais **non encore transcrit** (cf. §6).

| #   | slug                        | notion (unité officielle)                                                              | manuel élève (code · pages) | transcription |
| --- | --------------------------- | -------------------------------------------------------------------------------------- | --------------------------- | ------------- |
| 1   | `01-shir-jahili`            | المحور الأوّل : الشّعر الجاهلي                                                         | `201202` · p.5–83           | ✅            |
| 2   | `02-tajdid-shir-qarn-thani` | المحور الثاني : التجديد في الشّعر العربيّ في القرن الثاني للهجرة                       | `201202` · p.85–173         | ⏳            |
| 3   | `03-nadira`                 | المحور الثالث : من أشكال القصّ في الأدب العربيّ القديم — النّـادرة                     | `201202` · p.174–222        | ⏳            |
| 4   | `04-tawasul-shafawi-1`      | التواصل الشفويّ (1) : العلاقات بين الشّباب — المرئيّ والمكتوب                          | `201202` · p.223–241        | ⏳            |
| 5   | `05-waraqat-lughawiya-1`    | ورقات لغويّة (1) : التعبير عن الزمان في اللغة العربيّة — التركيب التلازميّ             | `201202` · p.242–252        | ⏳            |
| 6   | `06-romantiqiya`            | المحور الرابع : الرّومنطيقيّة في الأدب العربيّ                                         | `201203` · p.5–101          | ⏳            |
| 7   | `07-riwaya-khan-al-khalili` | المحور الخامس (المسلك الآداب) : الرّواية — خان الخليلي لنجيب محفوظ                     | `201203` · p.102–173        | ⏳            |
| 8   | `08-tawasul-shafawi-2`      | التواصل الشفويّ (2) : التقدّم العلمي والتّكنولوجي إلى أين؟ — حوار الحضارات             | `201203` · p.238–265        | ⏳            |
| 9   | `09-waraqat-lughawiya-2`    | دلالات الصيغ الصرفيّة : الجذر والصيغ والأوزان — صيغ الأفعال المزيدة — دلالات بعض الصيغ | `201203` · p.266–283        | ⏳            |
...
- **À valider par Mohamed** : (a) le **grain du chapitrage** — 1 محور = 1 chapitre (retenu ici, fidèle au
  découpage du manuel), alors que le محور 1 pèse 79 pages et 16 textes : un LOT B pourrait légitimement vouloir
  éclater ce chapitre par **غرض** (فخر / مدح / رثاء / غزل / حكمة), ce que le manuel lui-même suggère par ses
  ورقات منهجيّة ; (b) le **statut des chapitres 4, 5, 8 et 9** (التواصل الشفويّ et ورقات لغويّة) : ils sont au
  programme mais leur nature (débat oral, leçon de langue) se prête moins au QCM que les محاور littéraires —
  candidats à `optional: true` au manifeste si le produit le décide.
